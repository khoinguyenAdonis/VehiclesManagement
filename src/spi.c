...
void SPIRC552_Config(){
    ...
    GPIO_PinAFConfig(MFRC522_SPI_GPIO, GPIO_PinSource10, GPIO_AF_SPI3);
    GPIO_PinAFConfig(MFRC522_SPI_GPIO, GPIO_PinSource11, GPIO_AF_SPI3);
    GPIO_PinAFConfig(MFRC522_SPI_GPIO, GPIO_PinSource12, GPIO_AF_SPI3);
